    ...
    static Bot create(BotTypes type) {
        ...
        switch (type) {
            case AGGRO_BOT:
                ...
                bot.addEffectOnAttack(createFactoryForEffectWithDuration(1, DefenseDown.class, Stun.class));
                break;
            case STEALTH_BOT:
                bot = new Bot(STEALTH_BOT.toString(), 70, 20, 90, 500, 0.2, 0.2, 0.0, 0.4);
                bot.addEffectOnAttack(createFactoryForEffectWithDuration(2, SpeedDown.class, OffenseDown.class));
                break;
            case GLASS_BOT:
                bot = new Bot(GLASS_BOT.toString(), 180, 0, 20, 300, 0.3, 0.1, 0.05, 0.65);
                bot.addEffectOnAttack(createFactoryForEffectWithDuration(2, ContinuousDamage.class));
                break;
            case TANK_BOT:
                bot = new Bot(TANK_BOT.toString(), 50, 40, 30, 1200, 0.05, 0.1, 0.2, 0.25);
                bot.addEffectOnAttack(createFactoryForEffectWithDuration(3, Bomb.class));
                break;
            case BEAVERETTE_BOT:
            ...
            case KAMIKAZE_BOT:
                ...
                bot.addEffectOnAttack(createFactoryForEffectWithDurationAndAoE(2, Bomb.class));
                break;
