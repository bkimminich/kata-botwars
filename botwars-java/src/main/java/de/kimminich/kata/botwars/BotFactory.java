...
final class BotFactory {
    ...
    static Bot create(BotTypes type) {
        switch (type) {
            case AGGRO_BOT: return new Bot(AGGRO_BOT.toString(), 100, 20, 40, 800, 0.0, 0.1, 0.1, 0.3, StatusEffectFactory.createFactoryForEffectWithDuration(1, DefenseDown.class, Stun.class));
            ...
            case GLASS_BOT: return new Bot(GLASS_BOT.toString(), 180, 0, 20, 300, 0.3, 0.1, 0.05, 0.65, StatusEffectFactory.createFactoryForEffectWithDuration(2, ContinuousDamage.class));
