...
final class BotFactory {
    ...
    static Bot create(BotTypes type) {
        switch (type) {
            ...
            case KAMIKAZE_BOT: return new Bot(KAMIKAZE_BOT.toString(), 50, 0, 40, 500, 0.0, 0.2, 0.0, 0.65, StatusEffectFactory.createFactoryForEffectWithDuration(1, Bomb.class));
