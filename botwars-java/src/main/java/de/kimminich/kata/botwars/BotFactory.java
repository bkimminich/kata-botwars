...
final class BotFactory {
    ...
    static Bot create(BotTypes type) {
        switch (type) {
            ...
            case TANK_BOT: return new Bot(TANK_BOT.toString(), 50, 40, 30, 1200, 0.05, 0.1, 0.2, 0.25, StatusEffectFactory.createFactoryForEffectWithDuration(3, Bomb.class));
            case BEAVERETTE_BOT: return new Bot(BEAVERETTE_BOT.toString(), 70, 30, 35, 1000, 0.05, 0.15, 0.1);
            case KAMIKAZE_BOT: return new Bot(KAMIKAZE_BOT.toString(), 50, 0, 40, 500, 0.0, 0.2, 0.0, 0.65, StatusEffectFactory.createFactoryForEffectWithDurationAndAoE(2, Bomb.class));
